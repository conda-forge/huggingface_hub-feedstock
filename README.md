About huggingface_hub-feedstock
===============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/huggingface_hub-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/huggingface_hub-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
It is possible to list all of the versions of `huggingface_hub` available on your platform:
...
```
pixi search huggingface_hub --channel conda-forge
```
